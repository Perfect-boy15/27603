...
public class Invoice extends Inspection {
    ...
    public void setInvoiceNo(String invoiceNo) {
        if (invoiceNo == null || invoiceNo.trim().isEmpty()) throw new IllegalArgumentException("invoiceNo cannot be empty");
        this.invoiceNo = invoiceNo;
    }

    public double getInvoiceAmount() { return invoiceAmount; }
    public void setInvoiceAmount(double invoiceAmount) {
        if (invoiceAmount <= 0) throw new IllegalArgumentException("invoiceAmount must be > 0");
